...
'always on the limits, trying to get into business and trying to get out of debt, a very ancient slough, called by the Latins æs alienum, another’s brass, for some of their coins were made of brass;',
...
'and so he religiously devotes a part of his day to supplying his system with the raw material of bones; walking all the while he talks behind his oxen, which, with vegetable-made bones, jerk him and his lumbering plough along in spite of every obstacle.',
...
'Darwin, the naturalist, says of the inhabitants of Tierra del Fuego, that while his own party, who were well clothed and sitting close to a fire, were far from too warm,',
'these naked savages, who were farther off, were observed, to his great surprise, “to be streaming with perspiration at undergoing such a roasting.”',
...
'Why has man rooted himself thus firmly in the earth, but that he may rise in the same proportion into the heavens above?—for the nobler plants are valued for the fruit they bear at last in the air and light, far from the ground, and are not treated like the humbler esculents,',
...
'I do not mean to prescribe rules to strong and valiant natures, who will mind their own affairs whether in heaven or hell, and perchance build more magnificently and spend more lavishly than the richest,',
'without ever impoverishing themselves, not knowing how they live,—if, indeed, there are any such, as has been dreamed;',
...
'to keep yourself informed of the state of the markets, prospects of war and peace every where, and anticipate the tendencies of trade and civilization,—taking advantage of the results of all exploring expeditions, using new passages and all improvements in navigation;—',
'charts to be studied, the position of reefs and new lights and buoys to be ascertained, and ever, and ever, the logarithmic tables to be corrected,',
'for by the error of some calculator the vessel often splits upon a rock that should have reached a friendly pier,—there is the untold fate of La Perouse;—',
'universal science to be kept pace with, studying the lives of all great discoverers and navigators, great adventurers and merchants, from Hanno and the Phœnicians down to our day;',
...
'It is said that a flood-tide, with a westerly wind, and ice in the Neva, would sweep St.',
...
'When Madam Pfeiffer, in her adventurous travels round the world, from east to west, had got so near home as Asiatic Russia, she says that she felt the necessity of wearing other than a travelling dress, when she went to meet the authorities,',
...
'Only they who go to soirées and legislative halls must have new coats, coats to change as often as the man changes in them.',
...
'which will last as many years, thick pantaloons for two dollars, cowhide boots for a dollar and a half a pair, a summer hat for a quarter of a dollar, and a winter cap for sixty-two and a half cents, or a better be made at home at a nominal cost,',
...
'When I hear this oracular sentence, I am for a moment absorbed in thought, emphasizing to myself each word separately that I may come at the meaning of it, that I may find out by what degree of consanguinity They are related to me,',
...
'and then there would be some one in the company with a maggot in his head, hatched from an egg deposited there nobody knows when, for not even fire kills these things,',
...
'Formerly, when how to get my living honestly, with freedom left for my proper pursuits, was a question which vexed me even more than it does now,',
'for unfortunately I am become somewhat callous, I used to see a large box by the railroad, six feet long by three wide, in which the laborers locked up their tools at night,',
'and it suggested to me that every man who was hard pushed might get such a one for a dollar,',
'and, having bored a few auger holes in it, to admit the air at least, get into it when it rained and at night,',
'and hook down the lid,',
'and so have freedom in his love,',
'and in his soul be free.',
...
'Gookin, who was superintendent of the Indians subject to the Massachusetts Colony, writing in 1674, says, “The best of their houses are covered very neatly, tight and warm, with barks of trees, slipped from their bodies at those seasons when the sap is up,',
'and made into great flakes, with pressure of weighty timber, when they are green…',
...
'entitles him to the benefit of the improvements of centuries, spacious apartments, clean paint and paper, Rumford fireplace, back plastering, Venetian blinds, copper pump, spring lock, a commodious cellar,',
...
'An average house in this neighborhood costs perhaps eight hundred dollars, and to lay up this sum will take from ten to fifteen years of the laborer’s life, even if he is not encumbered with a family;—',
'estimating the pecuniary value of every man’s labor at one dollar a day, for if some receive more, others receive less;—',
...
'which commonly they have inherited with encumbrances, or else bought with hired money,—and we may regard one third of that toil as the cost of their houses,—but commonly they have not paid for them yet.',
...
'and it may still be urged, for our houses are such unwieldy property that we are often imprisoned rather than housed in them; and the bad neighborhood to be avoided is our own scurvy selves.',
...
'To know this I should not need to look farther than to the shanties which every where border our railroads, that last improvement in civilization;',
'where I see in my daily walks human beings living in sties,',
'and all winter with an open door, for the sake of light, without any visible, often imaginable, wood pile,',
...
'which we are taking west with us, invented for the ladies of the harem and the effeminate natives of the Celestial Empire,',
...
'When I consider how our houses are built and paid for, or not paid for,',
'and their internal economy managed and sustained, I wonder that the floor does not give way under the visitor while he is admiring the gewgaws upon the mantel-piece,',
'and let him through into the cellar, to some solid and honest though earthy foundation.',
...
'Are you one of the ninety-seven who fail, or of the three who succeed?',
'Answer me these questions, and then perhaps I may look at your bawbles and find them ornamental.',
'The cart before the horse is neither beautiful nor useful.',
'Before we can adorn our houses with beautiful objects the walls must be stripped, and our lives must be stripped, and beautiful housekeeping and beautiful living be laid for a foundation: now, a taste for the beautiful is most cultivated out of doors,',
'where there is no house and no housekeeper.',
'Old Johnson, in his “Wonder-Working Providence,” speaking of the first settlers of this town, with whom he was contemporary, tells us that “they burrow themselves in the earth for their first shelter under some hillside,',
'and, casting the soil aloft upon timber, they make a smoky fire against the earth, at the highest side.”',
...
'The secretary of the Province of New Netherland, writing in Dutch, in 1650, for the information of those who wished to take up land there, states more particularly that “those in New Netherland,',
'and especially in New England, who have no means to build farmhouses at first according to their wishes, dig a square pit in the ground, cellar fashion, six or seven feet deep, as long and as broad as they think proper, case the earth inside with wood all round the wall,',
...
'and cover the spars with bark or green sods, so that they can live dry and warm in these houses with their entire families for two, three,',
'and four years, it being understood that partitions are run through those cellars which are adapted to the size of the family.',
...
'One day, when my axe had come off and I had cut a green hickory for a wedge, driving it with a stone,',
'and had placed the whole to soak in a pond hole in order to swell the wood, I saw a striped snake run into the water,',
'and he lay on the bottom, apparently without inconvenience, as long as I stayed there, or more than a quarter of an hour;',
...
'I to pay four dollars and twenty-five cents to-night, he to vacate at five to-morrow morning, selling to nobody else meanwhile: I to take possession at six.',
...
'I was informed treacherously by a young Patrick that neighbor Seeley, an Irishman, in the intervals of the carting, transferred the still tolerable, straight,',
'and drivable nails, staples,',
'and spikes to his pocket,',
'and then stood when I came back to pass the time of day,',
...
'and perchance never raising any superstructure until we found a better reason for it than our temporal necessities even.',
...
'It was only how to put a core of truth within the ornaments, that every sugar plum in fact might have an almond or caraway seed in it,—',
'though I hold that almonds are most wholesome without the sugar,—',
'and not how the inhabitant, the indweller, might build truly within and without, and let the ornaments take care of themselves.',
...
'What of architectural beauty I now see, I know has gradually grown from within outward, out of the necessities and character of the indweller, who is the only builder,—',
'out of some unconscious truthfulness, and nobleness, without ever a thought for the appearance and whatever additional beauty of this kind is destined to be produced will be preceded by a like unconscious beauty of life.',
...
'At Cambridge College the mere rent of a student’s room,',
'which is only a little larger than my own, is thirty dollars each year, though the corporation had the advantage of building thirty-two side by side and under one roof,',
'and the occupant suffers the inconvenience of many and noisy neighbors,',
...
'The mode of founding a college is, commonly, to get up a subscription of dollars and cents, and then following blindly the principles of a division of labor to its extreme, a principle which should never be followed but with circumspection,—',
'to call in a contractor who makes this a subject of speculation, and he employs Irishmen or other operatives actually to lay the foundations, while the students that are to be are said to be fitting themselves for it;',
...
'or the boy who had attended the lectures on metallurgy at the Institute in the mean while, and had received a Rodgers’ penknife from his father?',
...
'and I learned from the experience of both years, not being in the least awed by many celebrated works on husbandry, Arthur Young among the rest, that if one would live simply and eat only the crop which he raised,',
'and raise no more than he ate,',
'and not exchange it for an insufficient quantity of more luxurious and expensive things, he would need to cultivate only a few rods of ground,',
'and that it would be cheaper to spade up that than to use oxen to plough it,',
...
'The expense of food for eight months, namely, from July 4th to March 1st, the time when these estimates were made, though I lived there more than two years,—not counting potatoes, a little green corn, and some peas,',
'which I had raised, nor considering the value of what was on hand at the last date, was',
'Rice,................... $ 1.73½',
...
'In all,............................ $36.78,',
'which subtracted from the sum of the outgoes leaves a balance of $25.21¾ on the one side,—',
'this being very nearly the means with which I started, and the measure of expenses to be incurred,—',
'and on the other, beside the leisure and independence and health thus secured, a comfortable house for me as long as I choose to occupy it.',
...
'I made a study of the ancient and indispensable art of bread-making, consulting such authorities as offered, going back to the primitive days and first invention of the unleavened kind,',
'when from the wildness of nuts and meats men first reached the mildness and refinement of this diet,',
'and travelling gradually down in my studies through that accidental souring of the dough which, it is supposed, taught the leavening process,',
'and through the various fermentations thereafter, till I came to “good, sweet, wholesome bread,” the staff of life.',
'Leaven, which some deem the soul of bread, the spiritus which fills its cellular tissue, which is religiously preserved like the vestal fire,—',
'some precious bottle-full, I suppose, first brought over in the Mayflower, did the business for America, and its influence is still rising, swelling, spreading, in cerealian billows over the land,—',
'this seed I regularly and faithfully procured from the village, till at length one morning I forgot the rules, and scalded my yeast;',
...
'and the rest cost me nothing of which I have not rendered an account, consisted of a bed, a table, a desk, three chairs, a looking-glass three inches in diameter, a pair of tongs and andirons, a kettle, a skillet,',
'and a frying-pan, a dipper, a wash-bowl, two knives and forks, three plates, one cup, one spoon, a jug for oil, a jug for molasses, and a japanned lamp.',
...
'If you are a seer, whenever you meet a man you will see all that he owns, ay,',
'and much that he pretends to disown, behind him, even to his kitchen furniture and all the trumpery which he saves and will not burn,',
...
'“When a town celebrates the busk,” says he, “having previously provided themselves with new clothes, new pots, pans,',
'and other household utensils and furniture, they collect all their worn out clothes and other despicable things, sweep and cleanse their houses, squares,',
'and the whole town of their filth,',
'which with all the remaining grain and other old provisions they cast together into one common heap, and consume it with fire.',
...
'I have scarcely heard of a truer sacrament, that is, as the dictionary defines it, “outward and visible sign of an inward and spiritual grace,” than this,',
'and I have no doubt that they were originally inspired directly from Heaven to do thus, though they have no biblical record of the revelation.',
...
'The only coöperation which is commonly possible is exceedingly partial and superficial; and what little true coöperation there is, is as if it were not, being a harmony inaudible to men.',
'If a man has faith, he will coöperate with equal faith everywhere; if he has not faith, he will continue to live like the rest of the world, whatever company he is joined to.',
'To coöperate, in the highest as well as the lowest sense, means to get our living together.',
...
'It was easy to see that they could not long be companions or coöperate, since one would not operate at all.',
...
'and lay their Heaven under an obligation by maintaining certain poor persons in all respects as comfortably as I maintain myself,',
'and have even ventured so far as to make them the offer, they have one and all unhesitatingly preferred to remain poor.',
...
'and go about like a Robin Goodfellow, peeping in at every cottage window, inspiring lunatics, and tainting meats,',
'and making darkness visible, instead of steadily increasing his genial heat and beneficence till he is of such brightness that no mortal can look him in the face,',
'and then, and in the mean while too, going about the world in his own orbit, doing it good, or rather, as a truer philosophy has discovered, the world going about him getting good.',
'When Phaeton, wishing to prove his heavenly birth by his beneficence, had the sun’s chariot but one day,',
'and drove out of the beaten track, he burned several blocks of houses in the lower streets of heaven,',
'and scorched the surface of the earth,',
'and dried up every spring,',
'and made the great desert of Sahara, till at length Jupiter hurled him headlong to the earth with a thunderbolt,',
'and the sun, through grief at his death, did not shine for a year.',
'There is no odor so bad as that which arises from goodness tainted.',
'It is human, it is divine, carrion.',
'If I knew for a certainty that a man was coming to my house with the conscious design of doing me good, I should run for my life, as from that dry and parching wind of the African deserts called the simoom,',
'which fills the mouth and nose and ears and eyes with dust till you are suffocated, for fear that I should get some of his good done to me,—some of its virus mingled with my blood.',
...
'I was wont to pity the clumsy Irish laborers who cut ice on the pond, in such mean and ragged clothes, while I shivered in my more tidy and somewhat more fashionable garments, till, one bitter cold day, one who had slipped into the water came to my house to warm him,',
'and I saw him strip off three pairs of pants and two pairs of stockings ere he got down to the skin, though they were dirty and ragged enough, it is true,',
'and that he could afford to refuse the extra garments which I offered him, he had so many intra ones.',
...
'I once heard a reverend lecturer on England, a man of learning and intelligence, after enumerating her scientific, literary,',
'and political worthies, Shakespeare, Bacon, Cromwell, Milton, Newton,',
'and others, speak next of her Christian heroes, whom, as if his profession required it of him, he elevated to a place far above all the rest, as the greatest of the great.',
...
'for the Dijlah, or Tigris, will continue to flow through Bagdad after the race of caliphs is extinct: if thy hand has plenty, be liberal as the date tree;',
...
'which, by accident, was on Independence Day, or the Fourth of July, 1845, my house was not finished for winter, but was merely a defence against the rain, without plastering or chimney, the walls being of rough, weather-stained boards, with wide chinks,',
...
'I was not only nearer to some of those which commonly frequent the garden and the orchard, but to those wilder and more thrilling songsters of the forest which never, or rarely, serenade a villager,—',
'the wood-thrush, the veery, the scarlet tanager, the field-sparrow, the whippoorwill, and many others.',
...
'and here and there, by degrees, its soft ripples or its smooth reflecting surface was revealed, while the mists, like ghosts, were stealthily withdrawing in every direction into the woods, as at the breaking up of some nocturnal conventicle.',
'The very dew seemed to hang upon the trees later into the day than usual, as on the sides of mountains.',
'This small lake was of most value as a neighbor in the intervals of a gentle rain storm in August, when, both air and water being perfectly still, but the sky overcast, mid-afternoon had all the serenity of evening,',
...
'From a hill top near by,',
'where the wood had been recently cut off, there was a pleasing vista southward across the pond, through a wide indentation in the hills which form the shore there,',
'where their opposite sides sloping toward each other suggested a stream flowing out in that direction through a wooded valley, but stream there was none.',
...
'which in time of flood I distinguished elevated perhaps by a mirage in their seething valley, like a coin in a basin, all the earth beyond the pond appeared like a thin crust insulated and floated even by this small sheet of interverting water,',
...
'If it were worth the while to settle in those parts near to the Pleiades or the Hyades, to Aldebaran or Altair, then I was really there, or at an equal remoteness from the life which I had left behind, dwindled and twinkling with as fine a ray to my nearest neighbor,',
...
'but by the mechanical nudgings of some servitor, are not awakened by our own newly-acquired force and aspirations from within, accompanied by the undulations of celestial music, instead of factory bells,',
...
'which, by the way are all external and superficial, is just such an unwieldy and overgrown establishment, cluttered with furniture and tripped up by its own traps, ruined by luxury and heedless expense, by want of calculation and a worthy aim,',
'as the million households in the land;',
...
'If I should only give a few pulls at the parish bell-rope,',
'as for a fire, that is, without setting the bell, there is hardly a man on his farm in the outskirts of Concord, notwithstanding that press of engagements which was his excuse so many times this morning, nor a boy, nor a woman, I might almost say,',
'but would forsake all and follow that sound, not mainly to save property from the flames,',
...
'news which I seriously think a ready wit might write a twelve-month, or twelve years, beforehand with sufficient accuracy.',
...
'and serve up a bull-fight when other entertainments fail, it will be true to the letter,',
'and give us as good an idea of the exact state or ruin of things in Spain as the most succinct and lucid reports under this head in the newspapers: and as for England, almost the last significant scrap of news from that quarter was the revolution of 1649;',
...
'The preacher, instead of vexing the ears of drowsy farmers on their day of rest at the end of the week,—',
'for Sunday is the fit conclusion of an ill-spent week, and not the fresh and brave beginning of a new one,—',
'with this one other draggle-tail of a sermon, should shout with thundering voice, “Pause!',
'Avast!',
...
'and work and wedge our feet downward through the mud and slush of opinion,',
'and prejudice, and tradition, and delusion, and appearance,',
'that alluvion which covers the globe, through Paris and London, through New York and Boston and Concord, through church and state, through poetry and philosophy and religion, till we come to a hard bottom and rocks in place,',
...
'or set a lamp-post safely,',
'or perhaps a gauge, not a Nilometer, but a Realometer, that future ages might know how deep a freshet of shams and appearances had gathered from time to time.',
...
'When the illiterate and perhaps scornful trader has earned by enterprise and industry his coveted leisure and independence,',
'and is admitted to the circles of wealth and fashion, he turns inevitably at last to those still higher but yet inaccessible circles of intellect and genius,',
...
'That age will be rich indeed when those relics which we call Classics,',
'and the still older and more than classic but even less known Scriptures of the nations, shall have still further accumulated, when the Vaticans shall be filled with Vedas and Zendavestas and Bibles, with Homers and Dantes and Shakespeares,',
...
'They read the nine thousandth tale about Zebulon and Sephronia, and how they loved as none had ever loved before, and neither did the course of their true love run smooth,—',
'at any rate, how it did run and stumble, and get up again and go on! how some poor unfortunate got up on to a steeple, who had better never have gone up as far as the belfry;',
'and then, having needlessly got him up there, the happy novelist rings the bell for all the world to come together and hear, O dear! how he did get down again!',
'For my part, I think that they had better metamorphose all such aspiring heroes of universal noveldom into man weathercocks, as they used to put heroes among the constellations,',
'and let them swing round there till they are rusty,',
'and not come down at all to bother honest men with their pranks.',
...
'All this they read with saucer eyes, and erect and primitive curiosity, and with unwearied gizzard, whose corrugations even yet need no sharpening, just as some little four-year-old bencher his two-cent gilt-covered edition of Cinderella,—',
'without any improvement, that I can see, in the pronunciation, or accent, or emphasis, or any more skill in extracting or inserting the moral.',
...
'which are themselves but dialects and provincial, we are in danger of forgetting the language which all things and events speak without metaphor,',
...
'Sometimes, in a summer morning, having taken my accustomed bath, I sat in my sunny doorway from sunrise till noon,',
'rapt in a revery, amidst the pines and hickories and sumachs, in undisturbed solitude and stillness, while the birds sing around or flitted noiseless through the house,',
'until by the sun falling in at my west window,',
'or the noise of some traveller’s wagon on the distant highway, I was reminded of the lapse of time.',
...
'for I lived like the Puri Indians, of whom it is said that “for yesterday, to-day, and to-morrow they have only one word, and they express the variety of meaning by pointing backward for yesterday, forward for to-morrow, and overhead for the passing day.”',
...
'Near the end of May, the sand-cherry (Cerasus pumila,) adorned the sides of the path with its delicate flowers arranged in umbels cylindrically about its short stems,',
'which last, in the fall, weighed down with good sized and handsome cherries, fell over in wreaths like rays on every side.',
...
'or, rather, like a comet, for the beholder knows not if with that velocity and with that direction it will ever revisit this system, since its orbit does not look like a returning curve,—',
'with its steam cloud like a banner streaming behind in golden and silver wreaths, like many a downy cloud which I have seen, high in the heavens, unfolding its masses to the light,—',
'as if this travelling demigod, this cloud-compeller, would ere long take the sunset sky for the livery of his train;',
'when I hear the iron horse make the hills echo with his snort like thunder, shaking the earth with his feet,',
'and breathing fire and smoke from his nostrils, (what kind of winged horse or fiery dragon they will put into the new Mythology I don’t know), it seems as if the earth had got a race now worthy to inhabit it.',
...
'Their train of clouds stretching far behind and rising higher and higher, going to heaven while the cars are going to Boston, conceals the sun for a minute and casts my distant field into the shade,',
'a celestial train beside which the petty train of cars which hugs the earth is but the barb of the spear.',
...
'(Let that be the name of your engine.) Men are advertised that at a certain hour and minute these bolts will be shot toward particular points of the compass; yet it interferes with no man’s business, and the children go to school on the other track.',
...
'On this morning of the Great Snow, perchance,',
'which is still raging and chilling men’s blood, I hear the muffled tone of their engine bell from out the fog bank of their chilled breath,',
'which announces that the cars are coming, without long delay, notwithstanding the veto of a New England north-east snow storm,',
'and I behold the ploughmen covered with snow and rime, their heads peering, above the mould-board which is turning down other than daisies and the nests of field-mice, like bowlders of the Sierra Nevada, that occupy an outside place in the universe.',
...
'I am refreshed and expanded when the freight train rattles past me,',
'and I smell the stores which go dispensing their odors all the way from Long Wharf to Lake Champlain, reminding me of foreign parts, of coral reefs, and Indian oceans, and tropical climes, and the extent of the globe.',
...
'These rags in bales, of all hues and qualities, the lowest condition to which cotton and linen descend, the final result of dress,—',
'of patterns which are now no longer cried up, unless it be in Milwaukie, as those splendid articles, English, French,',
'or American prints, ginghams, muslins, &c., gathered from all quarters both of fashion and poverty, going to become paper of one color or a few shades only, on which forsooth will be written tales of real life, high and low, and founded on fact!',
...
'Who has not seen a salt fish, thoroughly cured for this world, so that nothing can spoil it,',
...
'and the teamster shelter himself and his lading against sun wind and rain behind it,—',
'and the trader, as a Concord trader once did, hang it up by his door for a sign when he commences business, until at last his oldest customer cannot tell surely whether it be animal, vegetable, or mineral,',
'and yet it shall be as pure as a snowflake,',
'and if it be put into a pot and boiled, will come out an excellent dun fish for a Saturday’s dinner.',
'Next Spanish hides, with the tails still preserving their twist and the angle of elevation they had when the oxen that wore them were careering over the pampas of the Spanish main,—',
'a type of all obstinacy, and evincing how almost hopeless and incurable are all constitutional vices.',
...
'and now perchance stands over his bulk-head and thinks of the last arrivals on the coast, how they may affect the price for him, telling his customers this moment, as he has told them twenty times before this morning, that he expects some by the next train of prime quality.',
...
'and cow-yards in the air, drovers with their sticks,',
'and shepherd boys in the midst of their flocks, all but the mountain pastures, whirled along like leaves blown from the mountains by the September gales.',
...
'Yet I love to hear their wailing, their doleful responses, trilled along the wood-side; reminding me sometimes of music and singing birds; as if it were the dark and tearful side of music, the regrets and sighs that would fain be sung.',
...
'Near at hand you could fancy it the most melancholy sound in Nature, as if she meant by this to stereotype and make permanent in her choir the dying moans of a human being,—',
'some poor weak relic of mortality who has left hope behind, and howls like an animal, yet with human sobs, on entering the dark valley, made more awful by a certain gurgling melodiousness,—',
...
'In the mean while all the shore rang with the trump of bullfrogs, the sturdy spirits of ancient wine-bibbers and wassailers, still unrepentant, trying to sing a catch in their Stygian lake,—',
'if the Walden nymphs will pardon the comparison, for though there are almost no weeds, there are frogs there,—',
'who would fain keep up the hilarious rules of their old festal tables, though their voices have waxed hoarse and solemnly grave, mocking at mirth,',
'and the wine has lost its flavor,',
'and become only liquor to distend their paunches,',
'and sweet intoxication never comes to drown the memory of the past, but mere saturation and waterloggedness and distention.',
'The most aldermanic, with his chin upon a heart-leaf,',
'which serves for a napkin to his drooling chaps, under this northern shore quaffs a deep draught of the once scorned water,',
'and passes round the cup with the ejaculation tr-r-r-oonk, tr-r-r-oonk, tr-r-r-oonk! and straightway comes over the water from some distant cove the same password repeated,',
'where the next in seniority and girth has gulped down to his mark;',
'and when this observance has made the circuit of the shores, then ejaculates the master of ceremonies, with satisfaction, tr-r-r-oonk! and each in his turn repeats the same down to the least distended, leakiest, and flabbiest paunched, that there be no mistake;',
...
'Not even rats in the wall, for they were starved out, or rather were never baited in,—',
'only squirrels on the roof and under the floor, a whippoorwill on the ridge pole, a blue-jay screaming beneath the window, a hare or woodchuck under the house, a screech-owl or a cat-owl behind it, a flock of wild geese or a laughing loon on the pond,',
...
'I could always tell if visitors had called in my absence, either by the bended twigs or grass, or the print of their shoes,',
'and generally of what sex or age or quality they were by some slight trace left, as a flower dropped, or a bunch of grass plucked and thrown away, even as far off as the railroad, half a mile distant, or by the lingering odor of a cigar or pipe.',
...
'unless it were in the spring, when at long intervals some came from the village to fish for pouts,—',
...
'and in every sound and sight around my house, an infinite and unaccountable friendliness all at once like an atmosphere sustaining me, as made the fancied advantages of human neighborhood insignificant,',
'and I have never thought of them since.',
'Every little pine needle expanded and swelled with sympathy and befriended me.',
'I was so distinctly made aware of the presence of something kindred to me, even in scenes which we are accustomed to call wild and dreary,',
'and also that the nearest of blood to me and humanest was not a person nor a villager, that I thought no place could ever be strange to me again.—',
...
'Not to many men surely, the depot, the post-office, the bar-room, the meeting-house, the school-house, the grocery, Beacon Hill, or the Five Points,',
'where men most congregate, but to the perennial source of our life, whence in all our experience we have found that to issue, as the willow stands near the water and sends out its roots in that direction.',
'This will vary with different natures, but this is the place where a wise man will dig his cellar…',
'I one evening overtook one of my townsmen, who has accumulated what is called “a handsome property,”—though I never got a fair view of it,—',
'on the Walden road, driving a pair of cattle to market, who inquired of me how I could bring my mind to give up so many of the comforts of life.',
...
'such health, such cheer, they afford forever! and such sympathy have they ever with our race, that all Nature would be affected,',
'and the sun’s brightness fade,',
'and the winds would sigh humanely,',
'and the clouds rain tears,',
'and the woods shed their leaves and put on mourning in midsummer, if any man should ever for a just cause grieve.',
...
'At one o’clock the next day Massasoit “brought two fishes that he had shot,” about thrice as big as a bream; “these being boiled, there were at least forty looked for a share in them.',
...
'Who should come to my lodge this morning but a true Homeric or Paphlagonian man,—',
'he had so suitable and poetic a name that I am sorry I cannot print it here,—',
'a Canadian, a woodchopper and post-maker, who can hole fifty posts in a day, who made his last supper on a woodchuck which his dog caught.',
...
'Frequently he would leave his dinner in the bushes, when his dog had caught a woodchuck by the way,',
'and go back a mile and a half to dress it and leave it in the cellar of the house where he boarded, after deliberating first for half an hour whether he could not sink it in the pond safely till nightfall,—',
...
'He had been instructed only in that innocent and ineffectual way in which the Catholic priests teach the aborigines, by which the pupil is never educated to the degree of consciousness, but only to the degree of trust and reverence,',
...
'Yet I never, by any manœuvring, could get him to take the spiritual view of things; the highest that he appeared to conceive of was a simple expediency, such as you might expect an animal to appreciate; and this, practically, is true of most men.',
...
'There was a certain positive originality, however slight, to be detected in him,',
'and I occasionally observed that he was thinking for himself and expressing his own opinion, a phenomenon so rare that I would any day walk ten miles to observe it,',
...
'Far off as I lived, I was not exempted from the annual visitation which occurs, methinks, about the first of April, when every body is on the move; and I had my share of good luck, though there were some curious specimens among my visitors.',
...
'doctors, lawyers, uneasy housekeepers who pried into my cupboard and bed when I was out,—',
'how came Mrs. — to know that my sheets were not as clean as hers?—young men who had ceased to be young, and had concluded that it was safest to follow the beaten track of the professions,—',
'all these generally said that it was not possible to do so much good in my position.',
...
'to them life seemed full of danger,—what danger is there if you don’t think of any?—and they thought that a prudent man would carefully select the safest position, where Dr. B. might be on hand at a moment’s warning.',
...
'in short, all honest pilgrims, who came out to the woods for freedom’s sake, and really left the village behind, I was ready to greet with,—“Welcome, Englishmen! welcome, Englishmen!” for I had had communication with that race.',
...
'Before yet any woodchuck or squirrel had run across the road, or the sun had got above the shrub oaks, while all the dew was on, though the farmers warned me against it,—',
'I would advise you to do all your work if possible while the dew is on,—',
'I began to level the ranks of haughty weeds in my bean-field and throw dust upon their heads.',
...
'There the sun lighted me to hoe beans, pacing slowly backward and forward over that yellow gravelly upland, between the long green rows, fifteen rods,',
'the one end terminating in a shrub oak copse where I could rest in the shade, the other in a blackberry field where the green berries deepened their tints by the time I had made another bout.',
'Removing the weeds, putting fresh soil about the bean stems, and encouraging this weed which I had sown, making the yellow soil express its summer thought in bean leaves and blossoms rather than in wormwood and piper and millet grass, making the earth say beans instead of grass,—',
...
'and sometimes the man in the field heard more of travellers’ gossip and comment than was meant for his ear: “Beans so late! peas so late!”—for I continued to plant when others had begun to hoe,—the ministerial husbandman had not suspected it.',
'“Corn, my boy, for fodder; corn for fodder.”',
'“Does he live there?” asks the black bonnet of the gray coat;',
'and the hard-featured farmer reins up his grateful dobbin to inquire what you are doing where he sees no manure in the furrow, and recommends a little chip dirt, or any little waste stuff, or it may be ashes or plaster.',
...
'The night-hawk circled overhead in the sunny afternoons—for I sometimes made a day of it—like a mote in the eye, or in heaven’s eye, falling from time to time with a swoop and a sound as if the heavens were rent, torn at last to very rags and tatters,',
...
'and when there was a military turnout of which I was ignorant, I have sometimes had a vague sense all the day of some sort of itching and disease in the horizon, as if some eruption would break out there soon, either scarlatina or canker-rash,',
'until at length some more favorable puff of wind, making haste over the fields and up the Wayland road, brought me information of the “trainers.”',
...
'But sometimes it was a really noble and inspiring strain that reached these woods, and the trumpet that sings of fame, and I felt as if I could spit a Mexican with a good relish,—',
'for why should we always stand for trifles?—and looked round for a woodchuck or a skunk to exercise my chivalry upon.',
...
'Consider the intimate and curious acquaintance one makes with various kinds of weeds,—',
'it will bear some iteration in the account, for there was no little iteration in the labor,—',
'disturbing their delicate organizations so ruthlessly, and making such invidious distinctions with his hoe, levelling whole ranks of one species, and sedulously cultivating another.',
...
'and did not hoe them all once, I hoed them unusually well as far as I went,',
'and was paid for it in the end, “there being in truth,” as Evelyn says, “no compost or lætation whatsoever comparable to this continual motion, repastination,',
...
'I said to myself, I will not plant beans and corn with so much industry another summer, but such seeds, if the seed is not lost, as sincerity, truth, simplicity, faith, innocence,',
'and the like,',
'and see if they will not grow in this soil, even with less toil and manurance,',
...
'Cato says that the profits of agriculture are particularly pious or just, (maximeque pius quæstus),',
...
'and finish his labor with every day, relinquishing all claim to the produce of his fields,',
'and sacrificing in his mind not only his first but his last fruits also.',
'Chapter VIII: THE VILLAGE',
'After hoeing, or perhaps reading and writing, in the forenoon, I usually bathed again in the pond, swimming across one of its coves for a stint,',
'and washed the dust of labor from my person, or smoothed out the last wrinkle which study had made,',
...
'and which, taken in homœopathic doses, was really as refreshing in its way as the rustle of leaves and the peeping of frogs.',
...
'and such sound digestive organs, that they can sit forever in public avenues without stirring,',
'and let it simmer and whisper through them like the Etesian winds, or as if inhaling ether, it only producing numbness and insensibility to pain,—',
'otherwise it would often be painful to hear,—',
'without affecting the consciousness.',
'I hardly ever failed, when I rambled through the village, to see a row of such worthies, either sitting on a ladder sunning themselves, with their bodies inclined forward and their eyes glancing along the line this way and that, from time to time, with a voluptuous expression,',
...
'and the houses were so arranged as to make the most of mankind, in lanes and fronting one another, so that every traveller had to run the gantlet, and every man, woman, and child might get a lick at him.',
...
'For the most part I escaped wonderfully from these dangers, either by proceeding at once boldly and without deliberation to the goal, as is recommended to those who run the gantlet,',
'or by keeping my thoughts on high things, like Orpheus, who, “loudly singing the praises of the gods to his lyre, drowned the voices of the Sirens,',
...
'and after learning the kernels and very last sieve-ful of news, what had subsided, the prospects of war and peace,',
...
'It was very pleasant, when I stayed late in town, to launch myself into the night, especially if it was dark and tempestuous,',
'and set sail from some bright village parlor or lecture room, with a bag of rye or Indian meal upon my shoulder,',
'for my snug harbor in the woods, having made all tight without and withdrawn under hatches with a merry crew of thoughts, leaving only my outer man at the helm, or even tying up the helm when it was plain sailing.',
...
'I frequently had to look up at the opening between the trees above the path in order to learn my route, and,',
'where there was no cart-path, to feel with my feet the faint track which I had worn,',
'or steer by the known relation of particular trees which I felt with my hands, passing between two pines for instance, not more than eighteen inches apart, in the midst of the woods, invariably, in the darkest night.',
'Sometimes, after coming home thus late in a dark and muggy night, when my feet felt the path which my eyes could not see, dreaming and absent-minded all the way,',
'until I was aroused by having to raise my hand to lift the latch, I have not been able to recall a single step of my walk,',
'and I have thought that perhaps my body would find its way home if its master should forsake it, as the hand finds its way to the mouth without assistance.',
'Several times, when a visitor chanced to stay into evening,',
'and it proved a dark night, I was obliged to conduct him to the cart-path in the rear of the house,',
...
'A day or two after one of them told me that they wandered about the greater part of the night, close by their own premises,',
'and did not get home till toward morning, by which time, as there had been several heavy showers in the mean while,',
'and the leaves were very wet, they were drenched to their skins.',
...
'One afternoon, near the end of the first summer, when I went to the village to get a shoe from the cobbler’s, I was seized and put into jail, because, as I have elsewhere related, I did not pay a tax to, or recognize the authority of, the state which buys and sells men, women,',
'and children, like cattle at the door of its senate-house.',
...
'Yet, though many people of every class came this way to the pond, I suffered no serious inconvenience from these sources, and I never missed anything but one small book, a volume of Homer,',
'which perhaps was improperly gilded, and this I trust a soldier of our camp has found by this time.',
...
'and worn out all my village friends, I rambled still farther westward than I habitually dwell, into yet more unfrequented parts of the town, “to fresh woods and pastures new,” or, while the sun was setting, made my supper of huckleberries and blueberries on Fair Haven Hill,',
...
'Occasionally, after my hoeing was done for the day, I joined some impatient companion who had been fishing on the pond since morning, as silent and motionless as a duck or a floating leaf,',
'and, after practising various kinds of philosophy, had concluded commonly, by the time I arrived, that he belonged to the ancient sect of Cœnobites.',
...
'When, as was commonly the case, I had none to commune with, I used to raise the echoes by striking with a paddle on the side of my boat, filling the surrounding woods with circling and dilating sound, stirring them up as the keeper of a menagerie his wild beasts,',
...
'Formerly I had come to this pond adventurously, from time to time, in dark summer nights, with a companion, and making a fire close to the water’s edge, which we thought attracted the fishes, we caught pouts with a bunch of worms strung on a thread;',
'and when we had done, far in the night, threw the burning brands high into the air like skyrockets, which, coming down into the pond, were quenched with a loud hissing, and we were suddenly groping in total darkness.',
'Through this, whistling a tune, we took our way to the haunts of men again.',
'But now I had made my home by the shore.',
'Sometimes, after staying in a village parlor till the family had all retired, I have returned to the woods,',
'and, partly with a view to the next day’s dinner, spent the hours of midnight fishing from a boat by moonlight, serenaded by owls and foxes,',
'and hearing, from time to time, the creaking note of some unknown bird close at hand.',
'These experiences were very memorable and valuable to me,—',
'anchored in forty feet of water,',
'and twenty or thirty rods from the shore, surrounded sometimes by thousands of small perch and shiners, dimpling the surface with their tails in the moonlight,',
'and communicating by a long flaxen line with mysterious nocturnal fishes which had their dwelling forty feet below,',
'or sometimes dragging sixty feet of line about the pond as I drifted in the gentle night breeze, now and then feeling a slight vibration along it, indicative of some life prowling about its extremity, of dull uncertain blundering purpose there,',
...
'and looking with divided vision, so as to see the reflection, I have discerned a matchless and indescribable light blue,',
'such as watered or changeable silks and sword blades suggest, more cerulean than the sky itself, alternating with the original dark green on the opposite sides of the waves,',
...
'Once, in the winter, many years ago, when I had been cutting holes through the ice in order to catch pickerel, as I stepped ashore I tossed my axe back on to the ice, but, as if some evil genius had directed it, it slid four or five rods directly into one of the holes,',
...
'Making another hole directly over it with an ice chisel which I had, and cutting down the longest birch which I could find in the neighborhood with my knife, I made a slip-noose,',
'which I attached to its end, and, letting it down carefully, passed it over the knob of the handle, and drew it by a line along the birch, and so pulled the axe out again.',
...
'and of noticeable plants, except in the little meadows recently overflowed,',
'which do not properly belong to it, a closer scrutiny does not detect a flag nor a bulrush, nor even a lily, yellow or white, but only a few small heart-leaves and potamogetons, and perhaps a water-target or two;',
'all which however a bather might not perceive;',
'and these plants are clean and bright like the element they grow in.',
'The stones extend a rod or two into the water, and then the bottom is pure sand, except in the deepest parts,',
'where there is usually a little sediment, probably from the decay of the leaves which have been wafted on to it so many successive falls, and a bright green weed is brought up on anchors even in midwinter.',
...
'Perhaps on that spring morning when Adam and Eve were driven out of Eden Walden Pond was already in existence, and even then breaking up in a gentle spring rain accompanied with mist and a southerly wind, and covered with myriads of ducks and geese,',
'which had not heard of the fall, when still such pure lakes sufficed them.',
...
'I have been surprised to detect encircling the pond, even where a thick wood has just been cut down on the shore, a narrow shelf-like path in the steep hill-side, alternately rising and falling, approaching and receding from the water’s edge,',
...
'This is particularly distinct to one standing on the middle of the pond in winter, just after a light snow has fallen, appearing as a clear undulating white line, unobscured by weeds and twigs,',
...
'the water standing at this great height for a year or more, though it makes it difficult to walk round it, kills the shrubs and trees which have sprung up about its edge since the last rise, pitch-pines, birches, alders, aspens,',
...
'and they used much profanity, as the story goes, though this vice is one of which the Indians were never guilty,',
'and while they were thus engaged the hill shook and suddenly sank,',
'and only one old squaw, named Walden, escaped,',
...
'and this Indian fable does not in any respect conflict with the account of that ancient settler whom I have mentioned, who remembers so well when he first came here with his divining rod, saw a thin vapor rising from the sward,',
...
'so that, unfortunately, it is no longer a mystery to me.',
'I detect the paver.',
...
'The temperature of the pond water which had stood in the room where I sat from five o’clock in the afternoon till noon the next day, the sixth of March, 1846, the thermometer having been up to 65° or 70° some of the time, owing partly to the sun on the roof, was 42°,',
...
'There have been caught in Walden pickerel, one weighing seven pounds, to say nothing of another which carried off a reel with great velocity,',
'which the fisherman safely set down at eight pounds because he did not see him, perch and pouts, some of each weighing over two pounds, shiners, chivins or roach (Leuciscus pulchellus), a very few breams, and a couple of eels, one weighing four pounds,—',
'I am thus particular because the weight of a fish is commonly its only title to fame, and these are the only eels I have heard of here;—',
...
'There are also a clean race of frogs and tortoises, and a few muscels in it; muskrats and minks leave their traces about it, and occasionally a travelling mud-turtle visits it.',
...
'Ducks and geese frequent it in the spring and fall, the white-bellied swallows (Hirundo bicolor) skim over it, and the peetweets (Totanus macularius) “teter” along its stony shores all summer.',
...
'where the water is eight or ten feet deep, and also in some other parts of the pond, some circular heaps half a dozen feet in diameter by a foot in height, consisting of small stones less than a hen’s egg in size,',
...
'and if, between the two, you survey its surface critically, it is literally as smooth as glass, except where the skater insects, at equal intervals scattered over its whole extent, by their motions in the sun produce the finest imaginable sparkle on it,',
...
'From a hill-top you can see a fish leap in almost any part; for not a pickerel or shiner picks an insect from this smooth surface but it manifestly disturbs the equilibrium of the whole lake.',
...
'It is a soothing employment, on one of those fine days in the fall when all the warmth of the sun is fully appreciated, to sit on a stump on such a height as this, overlooking the pond,',
...
'One November afternoon, in the calm at the end of a rain storm of several days’ duration, when the sky was still completely overcast and the air was full of mist, I observed that the pond was remarkably smooth, so that it was difficult to distinguish its surface;',
...
'In such transparent and seemingly bottomless water, reflecting the clouds, I seemed to be floating through the air as in a balloon,',
'and their swimming impressed me as a kind of flight or hovering, as if they were a compact flock of birds passing just beneath my level on the right or left, their fins, like sails, set all around them.',
...
'which perchance had first been a tree on the bank, and then, as it were, fell into the water, to float there for a generation, the most proper vessel for the lake.',
...
'I have spent many an hour, when I was younger, floating over its surface as the zephyr willed, having paddled my boat to the middle,',
'and lying on my back across the seats, in a summer forenoon, dreaming awake, until I was aroused by the boat touching the sand,',
...
'Now the trunks of trees on the bottom, and the old log canoe, and the dark surrounding woods, are gone, and the villagers, who scarcely know where it lies, instead of going to the pond to bathe or drink, are thinking to bring its water,',
'which should be as sacred as the Ganges at least, to the village in a pipe, to wash their dishes with!—to earn their Walden by the turning of a cock or drawing of a plug!',
...
'I have said that Walden has no visible inlet nor outlet, but it is on the one hand distantly and indirectly related to Flint’s Pond,',
'which is more elevated, by a chain of small ponds coming from that quarter, and on the other directly and manifestly to Concord River,',
'which is lower, by a similar chain of ponds through which in some other geological period it may have flowed, and by a little digging,',
'which God forbid, it can be made to flow thither again.',
'If by living thus reserved and austere, like a hermit in the woods, so long, it has acquired such wonderful purity, who would not regret that the comparatively impure waters of Flint’s Pond should be mingled with it,',
...
'I used to admire the ripple marks on the sandy bottom, at the north end of this pond, made firm and hard to the feet of the wader by the pressure of the water,',
'and the rushes which grew in Indian file, in waving lines, corresponding to these marks, rank behind rank, as if the waves had planted them.',
...
'his fingers grown into crooked and horny talons from the long habit of grasping harpy-like;—so it is not named for me.',
...
'whose presence perchance cursed all the shore;',
...
'I respect not his labors, his farm where every thing has its price;',
'who would carry the landscape, who would carry his God, to market, if he could get any thing for him;',
...
'Goose Pond, of small extent, is on my way to Flint’s; Fair-Haven, an expansion of Concord River, said to contain some seventy acres, is a mile south-west; and White Pond, of about forty acres, is a mile and a half beyond Fair-Haven.',
...
'Since the woodcutters, and the railroad, and I myself have profaned Walden, perhaps the most attractive, if not the most beautiful, of all our lakes, the gem of the woods, is White Pond;—',
...
'“In the middle of the latter may be seen, when the water is very low, a tree which appears as if it grew in the place where it now stands, although the roots are fifty feet below the surface of the water;',
...
'Instead of the white lily, which requires mud, or the common sweet flag, the blue flag (Iris versicolor) grows thinly in the pure water, rising from the stony bottom all around the shore, where it is visited by humming birds in June;',
'and the color both of its bluish blades and its flowers, and especially their reflections, are in singular harmony with the glaucous water.',
...
'or to swamps where the usnea lichen hangs in festoons from the white-spruce trees, and toad-stools, round tables of the swamp gods, cover the ground, and more beautiful fungi adorn the stumps, like butterflies or shells, vegetable winkles;',
'where the swamp-pink and dogwood grow, the red alder-berry glows like eyes of imps, the waxwork grooves and crushes the hardest woods in its folds,',
'and the wild-holly berries make the beholder forget his home with their beauty,',
'and he is dazzled and tempted by nameless other wild forbidden fruits, too fair for mortal taste.',
'Instead of calling on some scholar, I paid many a visit to particular trees, of kinds which are rare in this neighborhood, standing far away in the middle of some pasture, or in the depths of a wood or swamp, or on a hill-top;',
...
'the beech, which has so neat a bole and beautifully lichen-painted, perfect in all its details,',
'of which, excepting scattered specimens, I know but one small grove of sizable trees left in the township, supposed by some to have been planted by the pigeons that were once baited with beech nuts near by;',
'it is worth the while to see the silver grain sparkle when you split this wood;',
'the bass; the hornbeam; the Celtis occidentalis, or false elm, of which we have but one well-grown;',
...
'Angelo, a resplendent light appeared over the shadow of his head at morning and evening, whether he was in Italy or France, and it was particularly conspicuous when the grass was moist with dew.',
...
'and when at length I had made one cast over the pickerel-weed, standing up to my middle in water, I found myself suddenly in the shadow of a cloud, and the thunder began to rumble with such emphasis that I could do no more than listen to it.',
...
'So the Muse fables.',
'But therein, as I found, dwelt now John Field, an Irishman,',
'and his wife,',
'and several children, from the broad-faced boy who assisted his father at his work,',
'and now came running by his side from the bog to escape the rain, to the wrinkled, sibyl-like, cone-headed infant that sat upon its father’s knee as in the palaces of nobles,',
'and looked out from its home in the midst of wet and hunger inquisitively upon the stranger, with the privilege of infancy, not knowing but it was the last of a noble line,',
'and the hope and cynosure of the world, instead of John Field’s poor starveling brat.',
...
'Meanwhile my host told me his story, how hard he worked “bogging” for a neighboring farmer, turning up a meadow with a spade or bog hoe at the rate of ten dollars an acre and the use of the land with manure for one year,',
'and his little broad-faced son worked cheerfully at his father’s side the while, not knowing how poor a bargain the latter had made.',
...
'and so it was as broad as it was long, indeed it was broader than it was long, for he was discontented and wasted his life into the bargain;',
...
'I told him, that as he worked so hard at bogging, he required thick boots and stout clothing,',
'which yet were soon soiled and worn out, but I wore light shoes and thin clothing,',
'which cost not half so much, though he might think that I was dressed like a gentleman, (which, however, was not the case,) and in an hour or two, without labor, but as a recreation, I could, if I wished, catch as many fish as I should want for two days,',
...
'therefore I suppose they still take life bravely, after their fashion, face to face, giving it tooth and nail, not having skill to split its massive columns with any fine entering wedge, and rout it in detail;—thinking to deal with it roughly, as one should handle a thistle.',
...
'Fishermen, hunters, woodchoppers,',
'and others, spending their lives in the fields and woods, in a peculiar sense a part of Nature themselves, are often in a more favorable mood for observing her, in the intervals of their pursuits, than philosophers or poets even, who approach her with expectation.',
'She is not afraid to exhibit herself to them.',
'The traveller on the prairie is naturally a hunter, on the head waters of the Missouri and Columbia a trapper, and at the Falls of St.',
'Mary a fisherman.',
...
'They mistake who assert that the Yankee has few amusements, because he has not so many public holidays,',
'and men and boys do not play so many games as they do in England, for here the more primitive but solitary amusements of hunting fishing and the like have not yet given place to the former.',
...
'and when some of my friends have asked me anxiously about their boys, whether they should let them hunt, I have answered, yes,—',
'remembering that it was one of the best parts of my education,—',
'make them hunters, though sportsmen only at first, if possible, mighty hunters at last, so that they shall not find game large enough for them in this or any vegetable wilderness,—',
...
'I have been surprised to consider that the only obvious employment, except wood-chopping, ice-cutting, or the like business,',
'which ever to my knowledge detained at Walden Pond for a whole half day any of my fellow-citizens, whether fathers or children of the town, with just one exception, was fishing.',
...
'Beside, there is something essentially unclean about this diet and all flesh, and I began to see where housework commences, and whence the endeavor,',
'which costs so much, to wear a tidy and respectable appearance each day, to keep the house sweet and free from all ill odors and sights.',
...
'and they lay it down as “a general rule, that almost all insects in this state eat much less than in that of larvæ.',
...
'And O, the housekeeping! to keep bright the devil’s door-knobs, and scour his tubs this bright day!',
...
'It comes on apace; my sumachs and sweet-briers tremble.—Eh, Mr. Poet, is it you?',
...
'The sport of digging the bait is nearly equal to that of catching the fish, when one’s appetite is not too keen; and this you may have all to yourself to-day.',
...
'A phœbe soon built in my shed, and a robin for protection in a pine which grew against the house.',
...
'The young suddenly disperse on your approach, at a signal from the mother, as if a whirlwind had swept them away,',
...
'and her anxious calls and mewing, or seen her trail her wings to attract his attention, without suspecting their neighborhood.',
...
'but at last, spying me, she would leave her young and circle round and round me, nearer and nearer till within four or five feet, pretending broken wings and legs, to attract my attention,',
'and get off her young, who would already have taken up their march, with faint wiry peep, single file through the swamp, as she directed.',
...
'In the mean while there came along a single red ant on the hill-side of this valley, evidently full of excitement, who either had despatched his foe, or had not yet taken part in the battle;',
...
'and the still living heads were hanging on either side of him like ghastly trophies at his saddle-bow, still apparently as firmly fastened as ever,',
'and he was endeavoring with feeble struggles, being without feelers and with only the remnant of a leg,',
...
'“Æneas Sylvius,” say they, “after giving a very circumstantial account of one contested with great obstinacy by a great and small species on the trunk of a pear tree,” adds that',
'“‘This action was fought in the pontificate of Eugenius the Fourth, in the presence of Nicholas Pistoriensis, an eminent lawyer, who related the whole history of the battle with the greatest fidelity.’',
...
'When I called to see her in June, 1842, she was gone a-hunting in the woods, as was her wont, (I am not sure whether it was a male or female,',
'and so use the more common pronoun,) but her mistress told me that she came into the neighborhood a little more than a year before, in April,',
...
'If I endeavored to overtake him in a boat, in order to see how he would manœuvre, he would dive and be completely lost, so that I did not discover him again, sometimes, till the latter part of the day.',
'But I was more than a match for him on the surface.',
'He commonly went off in a rain.',
'As I was paddling along the north shore one very calm October afternoon, for such days especially they settle on to the lakes, like the milkweed down, having looked in vain over the pond for a loon,',
'suddenly one, sailing out from the shore toward the middle a few rods in front of me, set up his wild laugh and betrayed himself.',
...
'At length, having come up fifty rods off, he uttered one of those prolonged howls, as if calling on the god of loons to aid him,',
...
'There too I admired, though I did not gather, the cranberries, small waxen gems, pendants of the meadow grass, pearly and red,',
'which the farmer plucks with an ugly rake, leaving the smooth meadow in a snarl, heedlessly measuring them by the bushel and the dollar only, and sells the spoils of the meads to Boston and New York;',
...
'It was very exciting at that season to roam the then boundless chestnut woods of Lincoln,—',
'they now sleep their long sleep under the railroad,—',
'with a bag on my shoulder,',
'and a stick to open burrs with in my hand,',
'for I did not always wait for the frost, amid the rustling of leaves and the loud reproofs of the red-squirrels and the jays, whose half-consumed nuts I sometimes stole,',
'for the burrs which they had selected were sure to contain sound ones.',
...
'and without the care of man the crow may carry back even the last seed of corn to the great cornfield of the Indian’s God in the south-west, whence he is said to have brought it;',
...
'As my bricks had been in a chimney before, though I did not read the name of Nebuchadnezzar on them, I picked out as many fire-place bricks as I could find, to save work and waste,',
'and I filled the spaces between the bricks about the fire-place with stones from the pond shore,',
...
'Cato says, the master of a family (patremfamilias) must have in his rustic villa “cellam oleariam, vinariam, dolia multa, uti lubeat caritatem expectare, et rei, et virtuti, et gloriæ erit,”',
'that is, “an oil and wine cellar, many casks, so that it may be pleasant to expect hard times;',
...
'I sometimes dream of a larger and more populous house, standing in a golden age, of enduring materials, and without ginger-bread work,',
'which shall still consist of only one room, a vast, rude, substantial, primitive hall, without ceiling or plastering, with bare rafters and purlins supporting a sort of lower heaven over one’s head,—useful to keep off rain and snow;',
'where the king and queen posts stand out to receive your homage, when you have done reverence to the prostrate Saturn of an older dynasty on stepping over the sill;',
'a cavernous house, wherein you must reach up a torch upon a pole to see the roof;',
'where some may live in the fire-place, some in the recess of a window, and some on settles, some at one end of the hall, some at another, and some aloft on rafters with the spiders, if they choose;',
...
'where you can see so necessary a thing as a barrel or a ladder, so convenient a thing as a cupboard,',
'and hear the pot boil,',
'and pay your respects to the fire that cooks your dinner and the oven that bakes your bread,',
...
'But as the last two days had been very warm, like an Indian summer, the ice was not now transparent, showing the dark green color of the water,',
'and the bottom, but opaque and whitish or gray,',
'and though twice as thick was hardly stronger than before, for the air bubbles had greatly expanded under this heat and run together,',
...
'and I was surprised to find that directly under the bubble the ice was melted with great regularity in the form of a saucer reversed, to the height of five eighths of an inch in the middle,',
'leaving a thin partition there between the water and the bubble, hardly an eighth of an inch thick;',
...
'Several times, when returning from the village at ten or eleven o’clock at night, I heard the tread of a flock of geese, or else ducks, on the dry leaves in the woods by a pond-hole behind my dwelling,',
'where they had come up to feed, and the faint honk or quack of their leader as they hurried off.',
...
'in ’46, the 16th; in ’49, about the 31st; and in ’50, about the 27th of December; in ’52, the 5th of January; in ’53, the 31st of December.',
...
'Gilpin, in his account of the forest borderers of England, says that “the encroachments of trespassers,',
'and the houses and fences thus raised on the borders of the forest,” were “considered as great nuisances by the old forest law,',
'and were severely punished under the name of purprestures, as tending ad terrorem ferarum—ad nocumentum forestæ, &c.,” to the frightening of the game and the detriment of the forest.',
...
'Michaux, more than thirty years ago, says that the price of wood for fuel in New York and Philadelphia “nearly equals,',
'and sometimes exceeds, that of the best wood in Paris, though this immense capital annually requires more than three hundred thousand cords,',
...
'the New Englander and the New Hollander, the Parisian and the Celt, the farmer and Robinhood, Goody Blake and Harry Gill, in most parts of the world the prince and the peasant, the scholar and the savage,',
...
'and warms that, instead of robbing himself, makes that his bed, in which he can move about divested of more cumbrous clothing, maintain a kind of summer in the midst of winter,',
...
'The elements, however, abetted me in making a path through the deepest snow in the woods, for when I had once gone through the wind blew the oak leaves into my tracks,',
'where they lodged, and by absorbing the rays of the sun melted the snow, and so not only made a dry bed for my feet, but in the night their dark line was my guide.',
...
'and the woods which border it were notched and dotted here and there with their little gardens and dwellings, though it was then much more shut in by the forest than now.',
...
'Not long since I read his epitaph in the old Lincoln burying-ground, a little on one side, near the unmarked graves of some British grenadiers who fell in the retreat from Concord,—',
'where he is styled “Sippio Brister,”—Scipio Africanus he had some title to be called,—',
'“a man of color,” as if he were discolored.',
...
'I lived on the edge of the village then, and had just lost myself over Davenant’s Gondibert, that winter that I labored with a lethargy,—',
'which, by the way, I never knew whether to regard as a family complaint, having an uncle who goes to sleep shaving himself,',
'and is obliged to sprout potatoes in a cellar Sundays, in order to keep awake and keep the Sabbath, or as the consequence of my attempt to read Chalmers’ collection of English poetry without skipping.',
...
'So we stood round our engine, jostled one another, expressed our sentiments through speaking-trumpets, or in lower tone referred to the great conflagrations which the world has witnessed, including Bascom’s shop,',
'and, between ourselves, we thought that, were we there in season with our “tub,” and a full frog-pond by, we could turn that threatened last and universal one into another flood.',
...
'It chanced that I walked that way across the fields the following night, about the same hour,',
'and hearing a low moaning at this spot, I drew near in the dark,',
'and discovered the only survivor of the family that I know, the heir of both its virtues and its vices, who alone was interested in this burning, lying on his stomach and looking over the cellar wall at the still smouldering cinders beneath, muttering to himself, as is his wont.',
...
'I had read of the potter’s clay and wheel in Scripture, but it had never occurred to me that the pots we use were not such as had come down unbroken from those days, or grown on trees like gourds somewhere,',
...
'which they stuck in the ground in the shadow of the house and daily watered, would root itself so,',
'and outlive them,',
'and house itself in the rear that shaded it,',
'and grown man’s garden and orchard,',
'and tell their story faintly to the lone wanderer a half century after they had grown up and died,—',
'blossoming as fair, and smelling as sweet, as in that first spring.',
...
'For a week of even weather I took exactly the same number of steps, and of the same length, coming and going, stepping deliberately and with the precision of a pair of dividers in my own deep tracks,—',
'to such routine the winter reduces us,—',
'yet often they were filled with heaven’s own blue.',
...
'Yet I rarely failed to find, even in mid-winter, some warm and springly swamp where the grass and the skunk-cabbage still put forth with perennial verdure, and some hardier bird occasionally awaited the return of spring.',
...
'We waded so gently and reverently, or we pulled together so smoothly, that the fishes of thought were not scared from the stream, nor feared any angler on the bank, but came and went grandly, like the clouds which float through the western sky,',
...
'Suddenly an unmistakable cat-owl from very near me, with the most harsh and tremendous voice I ever heard from any inhabitant of the woods, responded at regular intervals to the goose,',
...
'Sometimes I heard the foxes as they ranged over the snow crust, in moonlight nights, in search of a partridge or other game, barking raggedly and demoniacally like forest dogs, as if laboring with some anxiety,',
'or seeking expression, struggling for light and to be dogs outright and run freely in the streets;',
...
'One would approach at first warily through the shrub-oaks, running over the snow crust by fits and starts like a leaf blown by the wind, now a few paces this way, with wonderful speed and waste of energy, making inconceivable haste with his “trotters,” as if it were for a wager,',
'and now as many paces that way, but never getting on more than half a rod at a time;',
'and then suddenly pausing with a ludicrous expression and a gratuitous somerset, as if all the eyes in the universe were fixed on him,—',
'for all the motions of a squirrel, even in the most solitary recesses of the forest, imply spectators as much as those of a dancing girl,—',
'wasting more time in delay and circumspection than would have sufficed to walk the whole distance,—',
'I never saw one walk,—',
'and then suddenly, before you could say Jack Robinson, he would be in the top of a young pitch-pine, winding up his clock and chiding all imaginary spectators, soliloquizing and talking to all the universe at the same time,—',
'for no reason that I could ever detect, or he himself was aware of, I suspect.',
'At length he would reach the corn, and selecting a suitable ear, frisk about in the same uncertain trigonometrical way to the top-most stick of my wood-pile, before my window,',
'where he looked me in the face, and there sit for hours, supplying himself with a new ear from time to time, nibbling at first voraciously and throwing the half-naked cobs about;',
'till at length he grew more dainty still and played with his food, tasting only the inside of the kernel, and the ear,',
'which was held balanced over the stick by one paw, slipped from his careless grasp and fell to the ground, when he would look over at it with a ludicrous expression of uncertainty, as if suspecting that it had life, with a mind not made up whether to get it again,',
'or a new one,',
'or be off;',
...
'till at last, seizing some longer and plumper one, considerably bigger than himself,',
'and skilfully balancing it, he would set out with it to the woods, like a tiger with a buffalo, by the same zig-zag course and frequent pauses, scratching along with it as if it were too heavy for him and falling all the while,',
'making its fall a diagonal between a perpendicular and horizontal, being determined to put it through at any rate;—',
...
'At length the jays arrive, whose discordant screams were heard long before, as they were warily making their approach an eighth of a mile off,',
'and in a stealthy and sneaking manner they flit from tree to tree, nearer and nearer,',
...
'which, picking up the crumbs the squirrels had dropped, flew to the nearest twig, and, placing them under their claws, hammered away at them with their little bills, as if it were an insect in the bark, till they were sufficiently reduced for their slender throats.',
'A little flock of these tit-mice came daily to pick a dinner out of my wood-pile,',
'or the crumbs at my door, with faint flitting lisping notes, like the tinkling of icicles in the grass,',
'or else with sprightly day day day,',
'or more rarely, in spring-like days, a wiry summery phe-be from the wood-side.',
...
'Whichever side you walk in the woods the partridge bursts away on whirring wings, jarring the snow from the dry leaves and twigs on high, which comes sifting down in the sun-beams like golden dust; for this brave bird is not to be scared by winter.',
...
'and on they came, their hounding cry which made all the woods ring sounding nearer and nearer, now from Well-Meadow, now from the Baker Farm.',
'For a long time he stood still and listened to their music, so sweet to a hunter’s ear,',
'when suddenly the fox appeared, threading the solemn aisles with an easy coursing pace, whose sound was concealed by a sympathetic rustle of the leaves, swift and still, keeping the ground, leaving his pursuers far behind;',
...
'they are not now found here; and in his ledger, Feb. 7th, 1743, Hezekiah Stratton has credit “by ½ a Catt skin 0—1—4½;”',
...
'which had been gnawed by mice the previous winter,—a Norwegian winter for them, for the snow lay long and deep, and they were obliged to mix a large proportion of pine bark with their other diet.',
...
'and reflected every light and shadow, becomes solid to the depth of a foot or a foot and a half, so that it will support the heaviest teams,',
...
'Standing on the snow-covered plain, as if in a pasture amid the hills, I cut my way first through a foot of snow, and then a foot of ice, and open a window under my feet,',
'where, kneeling to drink, I look down into the quiet parlor of the fishes, pervaded by a softened light as through a window of ground glass, with its bright sanded floor the same as in summer;',
...
'which were four or five rods apart and an equal distance from the shore, and having fastened the end of the line to a stick to prevent its being pulled through, have passed the slack line over a twig of the alder, a foot or more above the ice, and tied a dry oak leaf to it,',
'which, being pulled down, would show when he had a bite.',
...
'or in the well which the fisherman cuts in the ice, making a little hole to admit the water, I am always surprised by their rare beauty, as if they were fabulous fishes, they are so foreign to the streets, even to the woods,',
...
'Some who have lain flat on the ice for a long time, looking down through the illusive medium, perchance with watery eyes into the bargain,',
'and driven to hasty conclusions by the fear of catching cold in their breasts, have seen vast holes “into which a load of hay might be driven,” if there were any body to drive it, the undoubted source of the Styx and entrance to the Infernal Regions from these parts.',
...
'William Gilpin, who is so admirable in all that relates to landscapes, and usually so correct, standing at the head of Loch Fyne, in Scotland,',
'which he describes as “a bay of salt water, sixty or seventy fathoms deep, four miles in breadth,” and about fifty miles long, surrounded by mountains, observes, “If we could have seen it immediately after the diluvian crash,',
'or whatever convulsion of Nature occasioned it, before the waters gushed in, what a horrid chasm must it have appeared!',
...
'Having noticed that the number indicating the greatest depth was apparently in the centre of the map, I laid a rule on the map lengthwise,',
'and then breadthwise,',
'and found, to my surprise, that the line of greatest length intersected the line of greatest breadth exactly at the point of greatest depth, notwithstanding that the middle is so nearly level, the outline of the pond far from regular,',
...
'Of five coves, three, or all which had been sounded, were observed to have a bar quite across their mouths and deeper water within, so that the bay tended to be an expansion of water within the land not only horizontally but vertically,',
'and to form a basin or independent pond, the direction of the two capes showing the course of the bar.',
...
'In order to see how nearly I could guess, with this experience, at the deepest point in a pond, by observing the outlines of its surface and the character of its shores alone, I made a plan of White Pond,',
'which contains about forty-one acres, and, like this, has no island in it, nor any visible inlet or outlet;',
...
'Such a rule of the two diameters not only guides us toward the sun in the system and the heart in man, but draw lines through the length and breadth of the aggregate of a man’s particular daily behaviors and waves of life into his coves and inlets,',
...
'When this bar is gradually increased by storms, tides,',
'or currents,',
'or there is a subsidence of the waters, so that it reaches to the surface, that which was at first but an inclination in the shore in which a thought was harbored becomes an individual lake, cut off from the ocean,',
'wherein the thought secures its own conditions, changes, perhaps, from salt to fresh, becomes a sweet sea, dead sea, or a marsh.',
'At the advent of each individual into this life, may we not suppose that such a bar has risen to the surface somewhere?',
'It is true, we are such poor navigators that our thoughts, for the most part, stand off and on upon a harborless coast, are conversant only with the bights of the bays of poesy, or steer for the public ports of entry, and go into the dry docks of science,',
'where they merely refit for this world, and no natural currents concur to individualize them.',
...
'One has suggested, that if such a “leach hole” should be found, its connection with the meadow, if any existed, might be proved by conveying some colored powder or sawdust to the mouth of the hole, and then putting a strainer over the spring in the meadow,',
...
'and a rain succeeds,',
'and finally a new freezing forms a fresh smooth ice over all, it is beautifully mottled internally by dark figures, shaped somewhat like a spider’s web, what you may call ice rosettes, produced by the channels worn by the water flowing from all sides to a centre.',
'Sometimes, also, when the ice was covered with shallow puddles, I saw a double shadow of myself, one standing on the head of the other, one on the ice, the other on the trees or hill-side.',
...
'In the winter of ’46–7 there came a hundred men of Hyperborean extraction swoop down on to our pond one morning, with many car-loads of ungainly-looking farming tools, sleds, ploughs, drill-barrows, turf-knives, spades, saws, rakes,',
'and each man was armed with a double-pointed pike-staff, such as is not described in the New-England Farmer or the Cultivator.',
...
'They went to work at once, ploughing, harrowing, rolling, furrowing, in admirable order, as if they were bent on making this a model farm;',
'but when I was looking sharp to see what kind of seed they dropped into the furrow, a gang of fellows by my side suddenly began to hook up the virgin mould itself, with a peculiar jerk, clean down to the sand, or rather the water,—',
'for it was a very springy soil,—',
'indeed all the terra firma there was,—',
'and haul it away on sleds, and then I guessed that they must be cutting peat in a bog.',
...
'and a hired man, walking behind his team, slipped through a crack in the ground down toward Tartarus,',
'and he who was so brave before suddenly became but the ninth part of a man, almost gave up his animal heat,',
...
'and these, being sledded to the shore, were rapidly hauled off on to an ice platform,',
'and raised by grappling irons and block and tackle, worked by horses, on to a stack, as surely as so many barrels of flour,',
'and there placed evenly side by side,',
'and row upon row, as if they formed the solid base of an obelisk designed to pierce the clouds.',
...
'but when they began to tuck the coarse meadow hay into the crevices, and this became covered with rime and icicles, it looked like a venerable moss-grown and hoary ruin, built of azure-tinted marble, the abode of Winter, that old man we see in the almanac,—',
...
'With favoring winds it is wafted past the site of the fabulous islands of Atlantis and the Hesperides, makes the periplus of Hanno,',
'and, floating by Ternate and Tidore and the mouth of the Persian Gulf, melts in the tropic gales of the Indian seas,',
...
'In spring the sun not only exerts an influence through the increased temperature of the air and earth, but its heat passes through ice a foot or more thick,',
'and is reflected from the bottom in shallow water,',
'and so also warms the water and melts the under side of the ice, at the same time that it is melting it more directly above, making it uneven,',
...
'As the weather grew warmer it was not sensibly worn away by the water, nor broken up and floated off as in rivers,',
'but, though it was completely melted for half a rod in width about the shore, the middle was merely honey-combed and saturated with water, so that you could put your foot through it when six inches thick;',
...
'One old man, who has been a close observer of Nature, and seems as thoroughly wise in regard to all her operations as if she had been put upon the stocks when he was a boy, and he had helped to lay her keel,—',
'who has come to his growth, and can hardly acquire more of natural lore if he should live to the age of Methuselah,—',
'told me, and I was surprised to hear him express wonder at any of Nature’s operations, for I thought that there were no secrets between them, that one spring day he took his gun and boat, and thought that he would have a little sport with the ducks.',
...
'After he had lain still there about an hour he heard a low and seemingly very distant sound, but singularly grand and impressive, unlike any thing he had ever heard, gradually swelling and increasing as if it would have a universal and memorable ending, a sullen rush and roar,',
'which seemed to him all at once like the sound of a vast body of fowl coming in to settle there, and, seizing his gun, he started up in haste and excited;',
'but he found, to his surprise, that the whole body of the ice had started while he lay there, and drifted in to the shore, and the sound he had heard was made by its edge grating on the shore,—',
'at first gently nibbled and crumbled off, but at length heaving up and scattering its wrecks along the island to a considerable height before it came to a stand still.',
'At length the sun’s rays have attained the right angle, and warm winds blow up mist and rain and melt the snow banks,',
'and the sun dispersing the mist smiles on a checkered landscape of russet and white smoking with incense,',
'through which the traveller picks his way from islet to islet, cheered by the music of a thousand tinkling rills and rivulets whose veins are filled with the blood of winter which they are bearing off.',
...
'a phenomenon not very common on so large a scale, though the number of freshly exposed banks of the right material must have been greatly multiplied since railroads were invented.',
...
'When the flowing mass reaches the drain at the foot of the bank it spreads out flatter into strands, the separate streams losing their semi-cylindrical form and gradually becoming more flat and broad, running together as they are more moist,',
'till they form an almost flat sand, still variously and beautifully shaded, but in which you can trace the original forms of vegetation;',
...
'and on the other this luxuriant foliage, the creation of an hour, I am affected as if in a peculiar sense I stood in the laboratory of the Artist who made the world and me,—',
'had come to where he was still at work, sporting on this bank, and with excess of energy strewing his fresh designs about.',
...
'Internally, whether in the globe or animal body, it is a moist thick lobe, a word especially applicable to the liver and lungs and the leaves of fat, (λείβω, labor, lapsus, to flow or slip downward, a lapsing;',
'λοβος, globus, lobe, globe;',
...
'If you look closely you observe that first there pushes forward from the thawing mass a stream of softened sand with a drop-like point, like the ball of the finger, feeling its way slowly and blindly downward,',
'until at last with more heat and moisture,',
'as the sun gets higher, the most fluid portion, in its effort to obey the law to which the most inert also yields, separates from the latter and forms for itself a meandering channel or artery within that,',
...
'and as many lobes as it has, in so many directions it tends to flow, and more heat or other genial influences would have caused it to flow yet farther.',
...
'When the ground was partially bare of snow, and a few warm days had dried its surface somewhat, it was pleasant to compare the first tender signs of the infant year just peeping forth with the stately beauty of the withered vegetation which had withstood the winter,—',
'life-everlasting, golden-rods, pinweeds, and graceful wild grasses, more obvious and interesting frequently than in summer even, as if their beauty was not ripe till then;',
...
'and lo! where yesterday was cold gray ice there lay the transparent pond already calm and full of hope as in a summer evening, reflecting a summer evening sky in its bosom, though none was visible overhead, as if it had intelligence with some remote horizon.',
...
'and when they had got into rank circled about over my head, twenty-nine of them,',
...
'and in due time I heard the martins twittering over my clearing, though it had not seemed that the township contained so many that it could afford me any,',
...
'and see how his exhausted and debauched veins expand with still joy and bless the new day, feel the spring influence with the innocence of infancy,',
...
'On the 29th of April, as I was fishing from the bank of the river near the Nine-Acre-Corner bridge, standing on the quaking grass and willow roots,',
'where the muskrats lurk, I heard a singular rattling sound, somewhat like that of the sticks which boys play with their fingers,',
'when, looking up, I observed a very slight and graceful hawk, like a night-hawk, alternately soaring like a ripple and tumbling a rod or two over and over, showing the underside of its wings,',
'which gleamed like a satin ribbon in the sun, or like the pearly inside of a shell.',
...
'Ah!',
'I have penetrated to those meadows on the morning of many a first spring day, jumping from hummock to hummock, from willow root to willow root,',
'when the wild river valley and the woods were bathed in so pure and bright a light as would have waked the dead, if they had been slumbering in their graves, as some suppose.',
...
'and other trees, just putting out amidst the pine woods around the pond, imparted a brightness like sunshine to the landscape, especially in cloudy days, as if the sun were breaking through mists and shining faintly on the hill-sides here and there.',
...
'Be rather the Mungo Park, the Lewis and Clarke and Frobisher, of your own streams and oceans; explore your own higher latitudes,—with shiploads of preserved meats to support you, if they be necessary; and pile the empty cans sky-high for a sign.',
...
'What was the meaning of that South-Sea Exploring Expedition, with all its parade and expense,',
'but an indirect recognition of the fact, that there are continents and seas in the moral world to which every man is an isthmus or an inlet, yet unexplored by him,',
...
'If you would learn to speak all tongues and conform to the customs of all nations, if you would travel farther than all travellers, be naturalized in all climes,',
'and cause the Sphinx to dash her head against a stone, even obey the precept of the old philosopher,',
'and Explore thyself.',
...
'We are often reminded that if there were bestowed on us the wealth of Crœsus, our aims must still be the same, and our means essentially the same.',
...
'I delight to come to my bearings,—',
'not walk in procession with pomp and parade, in a conspicuous place, but to walk even with the Builder of the universe, if I may,—',
'not to live in this restless, nervous, bustling, trivial Nineteenth Century, but stand or sit thoughtfully while it goes by.',
...
'and hide its head from me who might, perhaps, be its benefactor,',
'and impart to its race some cheering information, I am reminded of the greater Benefactor and Intelligence that stands over me the human insect.',
...
'Every one has heard the story which has gone the rounds of New England, of a strong and beautiful bug which came out of the dry leaf of an old table of apple-tree wood,',
'which had stood in a farmer’s kitchen for sixty years, first in Connecticut, and afterward in Massachusetts,—from an egg deposited in the living tree many years earlier still, as appeared by counting the annual layers beyond it;',
...
'Who knows what beautiful and winged life, whose egg has been buried for ages under many concentric layers of woodenness in the dead dry life of society, deposited at first in the alburnum of the green and living tree,',
'which has been gradually converted into the semblance of its well-seasoned tomb,—',
'heard perchance gnawing out now for years by the astonished family of man, as they sat round the festive board,—',
'may unexpectedly come forth from amidst society’s most trivial and handselled furniture, to enjoy its perfect summer life at last!',
